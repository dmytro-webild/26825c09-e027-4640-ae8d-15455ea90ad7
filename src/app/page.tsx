...
export default function LandingPage() {
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        ...
        {
          id: "a4",          name: "Brand Identity",          price: "Design",          variant: "Graphic",          imageSrc: "http://img.b2bpic.net/free-photo/hotel_1127-4044.jpg"},
        {
          id: "a5",          name: "Restaurant Promo",          price: "Video",          variant: "Reel",          imageSrc: "http://img.b2bpic.net/free-photo/drone-shot-wild-foss-sidu-cascade-river-flow-running-off-frozen-cliffs-icelandic-beautiful-waterfall-iceland-flowing-down-off-mountains-fantastic-panoramic-landscape-slow-motion_482257-69434.jpg"},
        {
          id: "a6",          name: "Real Estate",          price: "Drone",          variant: "Cinematic",          imageSrc: "http://img.b2bpic.net/free-photo/closeup-drone-flying-green-field-forest_181624-61188.jpg"},
      ]}
      title="Portfolyo"
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        {
          id: "m3",          value: "100%",          description: "Memnuniyet"},
      ]}
      title="Neden Biz?"
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        {
          id: "3",          name: "Can Demir",          role: "Kurucu",          company: "Startup",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-businessman-with-tie_1098-2867.jpg"},
        {
          id: "4",          name: "Deniz Kara",          role: "Müdür",          company: "Restaurant",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/smiling-businessman-standing-airport-terminal_107420-85070.jpg"},
        {
          id: "5",          name: "Efe Çelik",          role: "Kurucu",          company: "Dizi",          rating: 5,
